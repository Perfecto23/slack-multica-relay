...
Presentation and footer behavior were adapted from merged PRs #3 and #4 in `winchesHe/slack-multica-relay`; operating guidance was adapted from PR #5 for this repository's context and private-configuration boundaries.
